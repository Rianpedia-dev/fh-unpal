                    ...
                    <div className="container mx-auto max-w-6xl">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight transform transition-all duration-300 hover:scale-105" style={{
                                background: 'linear-gradient(to right, #fefce8, #ece635ff, #f9cd5eff)',
                                WebkitBackgroundClip: 'text',
                                WebkitTextFillColor: 'transparent',
                                backgroundClip: 'text',
                                WebkitTextStroke: '1px #f6ea0cff',
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="space-y-12 mb-24 px-4 sm:px-0">
                    <MotionDiv
                        ...
                        viewport={{ once: true }}
                        className="glass-card p-8 md:p-12 rounded-[2.5rem] border border-brand-red shadow-[0_0_20px_rgba(185,28,28,0.2)] relative overflow-hidden group mx-auto shadow-[0_0_80px_rgba(16,185,129,0.1)]"
                    >
                    ...
                    <MotionDiv
                        ...
                        viewport={{ once: true }}
                        className="glass-card p-8 md:p-12 rounded-[2.5rem] border border-brand-red shadow-[0_0_20px_rgba(185,28,28,0.2)] relative overflow-hidden group shadow-[0_0_80px_rgba(147,51,234,0.1)]"
                    >
                        {/* Premium Background gradients */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-24 px-4 sm:px-0">
                    <MotionDiv
                        className="glass-card p-12 md:p-16 rounded-[3.5rem] border border-brand-red shadow-[0_0_20px_rgba(185,28,28,0.2)] relative overflow-hidden group shadow-[0_0_80px_rgba(0,240,255,0.05)] h-full"
                        whileHover={{ y: -12 }}
                    ...
                    <MotionDiv
                        className="glass-card p-12 md:p-16 rounded-[3.5rem] border border-brand-red shadow-[0_0_20px_rgba(185,28,28,0.2)] relative overflow-hidden group shadow-[0_0_80px_rgba(147,51,234,0.05)] h-full"
                        whileHover={{ y: -12 }}
                        initial={{ opacity: 0, x: 50 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.8, delay: 0.2 }}
                ...
                {profile.objectives && (
                    ...
                    >
                        <div className="glass-card p-8 md:p-12 rounded-[2.5rem] border border-brand-red shadow-[0_0_20px_rgba(185,28,28,0.2)] relative overflow-hidden group shadow-[0_0_80px_rgba(16,185,129,0.05)]">
                            {/* Premium Background gradients */}
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-emerald-500/5 rounded-full blur-[120px] -z-10"></div>
